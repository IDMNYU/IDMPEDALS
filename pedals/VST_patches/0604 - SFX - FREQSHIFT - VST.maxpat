...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 407.5, 395.0, 44.0, 22.0 ],
					"text" : "mix $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.0, 395.0, 45.0, 22.0 ],
					"text" : "fine $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 494.5, 395.0, 55.0, 22.0 ],
					"text" : "mode $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 229.166666666666629, 395.0, 46.0, 22.0 ],
					"text" : "freq $1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 313.0, 183.0, 264.0, 23.0 ],
...
,
									"text" : "param mode @value 0 @enum Hilbert Polyphase",
									"varname" : "mode"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 244.0, 147.0, 217.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"displayorder" : "-",
										"order" : "0",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 108.0, 75.0, 249.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"displayorder" : "-",
										"order" : "0",
...
,
									"text" : "param freq @min 0.1 @max 5000 @value 300",
									"varname" : "freq"
								}
...
,
											...
											"boxes" : [ 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "in 5",
														"patching_rect" : [ 741.0, 142.0, 28.0, 22.0 ],
														"numinlets" : 0,
														"id" : "obj-4",
														"numoutlets" : 1,
														"outlettype" : [ "" ]
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "out 2",
														"patching_rect" : [ 88.25, 738.0, 35.0, 22.0 ],
														"fontsize" : 12.0,
														"numinlets" : 1,
														"id" : "obj-2",
														"numoutlets" : 0
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "out 1",
														"patching_rect" : [ 43.25, 738.0, 35.0, 22.0 ],
														"fontsize" : 12.0,
														"numinlets" : 1,
														"id" : "obj-7",
														"numoutlets" : 0
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "!- 1.",
														"patching_rect" : [ 708.0, 575.0, 29.0, 22.0 ],
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "in 3",
														"patching_rect" : [ 715.0, 105.0, 28.0, 22.0 ],
														"color" : [ 0.50195974111557, 0.0, 0.008130922913551, 1.0 ],
														"numinlets" : 0,
														"id" : "obj-10",
														"numoutlets" : 1,
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "in 4",
														"patching_rect" : [ 708.0, 537.0, 28.0, 22.0 ],
														"color" : [ 0.028541615232825, 0.250918865203857, 0.50196373462677, 1.0 ],
														"numinlets" : 0,
														"id" : "obj-8",
														"numoutlets" : 1,
...
, 												{
													"box" : 													{
														"maxclass" : "codebox",
														"patching_rect" : [ 116.0, 184.0, 580.5, 416.0 ],
														"fontsize" : 12.0,
														"numinlets" : 3,
														"id" : "obj-6",
														"fontname" : "Menlo",
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "in 2",
														"patching_rect" : [ 677.5, 75.0, 28.0, 22.0 ],
														"color" : [ 0.50195974111557, 0.0, 0.008130922913551, 1.0 ],
														"numinlets" : 0,
														"id" : "obj-5",
														"numoutlets" : 1,
...
, 												{
													"box" : 													{
														"maxclass" : "comment",
														"text" : "mono pedal",
														"patching_rect" : [ 135.0, 738.0, 71.0, 20.0 ],
														"numinlets" : 1,
														"id" : "obj-80",
														"numoutlets" : 0
													}
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "mix",
														"patching_rect" : [ 116.0, 622.0, 580.5, 22.0 ],
														"fontsize" : 12.0,
														"numinlets" : 3,
														"id" : "obj-3",
														"numoutlets" : 1,
...
,
									...
									"patching_rect" : [ 54.0, 217.0, 170.0, 23.0 ],
									"rnbo_classname" : "gen~",
									"rnbo_extra_attributes" : 									{
										"exposeparams" : 0
									}
						...
						"export_config" : 						{
							"vst-au-export" : 							{
								"vst-au-export-ins" : 								{
									...
									"plugin_name" : "IDM-FreqShiftRingMod-plugin",
...
,
					"patching_rect" : [ 180.5, 467.0, 200.0, 22.0 ],
					"rnboattrcache" : 					{
						"fine" : 						{
							"label" : "fine",
							"isEnum" : 0,
...
,
							"__presetid" : "IDM-FreqShiftRingMod"
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
...
,
									"fileref" : 									{
										"name" : "Lowpass",
										"filename" : "Lowpass_20230222_19.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "15e298eedf630d54b7773004951d204c"
									}
...
,
					"text" : "rnbo~ @title IDM-FreqShiftRingMod",
...
,
		"dependency_cache" : [ 			{
				"name" : "Lowpass_20230222_19.maxsnap",
