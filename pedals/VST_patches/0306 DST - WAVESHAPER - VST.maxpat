...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 370.0, 336.0, 41.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 370.0, 393.0, 51.0, 22.0 ],
					"text" : "input $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 282.5, 336.0, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.5, 393.0, 43.0, 22.0 ],
					"text" : "clip $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 465.0, 336.0, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 393.0, 59.0, 22.0 ],
					"text" : "output $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 186.5, 336.0, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.5, 393.0, 51.0, 22.0 ],
					"text" : "wrap $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 98.5, 336.0, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.5, 393.0, 45.0, 22.0 ],
					"text" : "fold $1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 175.0, 111.0, 237.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 434.0, 257.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 434.0, 221.0, 221.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"displayorder" : "-",
										"exponent" : 1.0,
...
,
									"text" : "param clip @min 0. @max 0.99 @value 0",
									"varname" : "clip"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 347.0, 221.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 347.0, 185.0, 229.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"displayorder" : "-",
										"exponent" : 1.0,
...
,
									"text" : "param wrap @min 0. @max 0.99 @value 0",
									"varname" : "wrap"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 246.0, 185.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 246.0, 149.0, 226.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"displayorder" : "-",
										"exponent" : 1.0,
...
,
									"text" : "param fold @min 0. @max 0.99 @value 0.",
									"varname" : "fold"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 108.0, 75.0, 229.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"displayorder" : "-",
										"exponent" : 1.0,
...
,
									"text" : "param input @min -70 @max 15 @value 0",
									"varname" : "input"
								}
...
,
											...
											"boxes" : [ 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "fixnan",
														"patching_rect" : [ 193.0, 463.0, 41.0, 22.0 ],
														"numinlets" : 1,
														"id" : "obj-1",
														"numoutlets" : 1,
														"outlettype" : [ "" ]
...
, 												{
													"box" : 													{
														"maxclass" : "comment",
														"text" : "mono pedal",
														"patching_rect" : [ 277.0, 545.0, 71.0, 20.0 ],
														"numinlets" : 1,
														"id" : "obj-5",
														"numoutlets" : 0
													}
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "in 3",
														"patching_rect" : [ 248.5, 359.5, 28.0, 22.0 ],
														"numinlets" : 0,
														"id" : "obj-46",
														"numoutlets" : 1,
														"outlettype" : [ "" ]
...
, 												{
													"box" : 													{
														...
														"text" : "in 6",
														"color" : [ 0.028541615232825, 0.250918865203857, 0.50196373462677, 1.0 ],
														"patching_rect" : [ 709.0, 139.0, 28.0, 22.0 ],
														"numinlets" : 0,
														"id" : "obj-21",
														"numoutlets" : 1,
														"outlettype" : [ "" ]
...
, 												{
													"box" : 													{
														...
														"text" : "in 5",
														"color" : [ 0.065929934382439, 0.501798808574677, 0.006832201499492, 1.0 ],
														"patching_rect" : [ 471.0, 139.0, 28.0, 22.0 ],
														"numinlets" : 0,
														"id" : "obj-3",
														"numoutlets" : 1,
														"outlettype" : [ "" ]
...
, 												{
													"box" : 													{
														...
														"text" : "in 4",
														"color" : [ 0.50195974111557, 0.0, 0.008130922913551, 1.0 ],
														"patching_rect" : [ 244.0, 138.0, 28.0, 22.0 ],
														"numinlets" : 0,
														"id" : "obj-19",
														"numoutlets" : 1,
														"outlettype" : [ "" ]
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "dcblock",
														"patching_rect" : [ 193.0, 505.0, 49.0, 22.0 ],
														"numinlets" : 1,
														"id" : "obj-37",
														"numoutlets" : 1,
														"outlettype" : [ "" ]
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "in 2",
														"patching_rect" : [ 177.0, 101.0, 28.0, 22.0 ],
														"numinlets" : 0,
														"id" : "obj-15",
														"numoutlets" : 1,
														"outlettype" : [ "" ]
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "out 2",
														"patching_rect" : [ 233.5, 545.0, 35.0, 22.0 ],
														"numinlets" : 1,
														"id" : "obj-9",
														"numoutlets" : 0
													}
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "out 1",
														"patching_rect" : [ 192.0, 545.0, 35.0, 22.0 ],
														"numinlets" : 1,
														"id" : "obj-8",
														"numoutlets" : 0
													}
...
,
									...
									"patching_rect" : [ 54.0, 217.0, 140.0, 23.0 ],
									"rnbo_classname" : "gen~",
									"rnbo_extra_attributes" : 									{
										"exposeparams" : 0
									}
						...
						"export_config" : 						{
							"vst-au-export" : 							{
								"vst-au-export-ins" : 								{
									...
									"plugin_name" : "IDM-Waveshaper-plugin",
...
,
					"patching_rect" : [ 23.0, 467.0, 170.0, 22.0 ],
					"rnboattrcache" : 					{
						"clip" : 						{
							"label" : "clip",
							"isEnum" : 0,
...
,
									"fileref" : 									{
										"name" : "Lowpass",
										"filename" : "Lowpass_20230221_9.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "354d17292d83516aa10bc5cc1df15513"
									}
...
,
					"text" : "rnbo~ @title IDM-Waveshaper",
					"varname" : "Waveshaper"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "Lowpass_20230221_9.maxsnap",
