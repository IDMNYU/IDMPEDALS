...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 775.5, 719.0, 144.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 775.5, 446.0, 157.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 486.5, 220.5, 36.0, 22.0 ],
									"text" : "> 1.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 775.5, 689.0, 157.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 775.5, 655.999999999999886, 151.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 775.5, 621.0, 152.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 775.5, 590.500000000000114, 145.0, 22.0 ],
									"text" : "gen @file fx_mod_phaser"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 775.5, 553.0, 145.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 775.5, 517.0, 151.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 775.5, 481.0, 145.0, 22.0 ],
									"text" : "gen @file fx_mod_chorus"
								}
...
, 							{
								"box" : 								{
									"code" : "insamp = in1;\r\np1 = in2;\r\np2 = in3;\r\np3 = in4;\r\np4 = in5;\r\np5 = in6;\r\np6 = in7;\r\ns1 = in8;\r\ns2 = in9;\r\ns3 = in10;\r\npgm = in11;\r\noutsamp = 0;\r\nlfo = 0;\r\nenv = 0;\r\n\r\nif(pgm==1) outsamp, lfo, env = fx_dyn_tremolo(insamp, p1, p2, p3, s1);\r\nelse if(pgm==2) outsamp, lfo = fx_mod_chorus(insamp, p1, p2, s1);\r\nelse if(pgm==3) outsamp, lfo = fx_mod_chorus2(insamp, p1, p2, p3, p4, s1);\r\nelse if(pgm==4) outsamp, lfo = fx_mod_flanger(insamp, p1, p2, p3, p4, s1);\r\nelse if(pgm==5) outsamp, lfo = fx_mod_phaser(insamp, p1, p2);\r\nelse if(pgm==6) outsamp, lfo, env = fx_mod_phaser2(insamp, p1, p2, p3, p4, p5, s1);\r\nelse if(pgm==7) outsamp, lfo = fx_mod_shcomb(insamp, p1, p2, p3, p4, p5, s1);\r\nelse if(pgm==8) outsamp, lfo = fx_mod_shcomb2(insamp, p1, p2, p3, p4, p5, p6, s1);\r\nelse if(pgm==9) outsamp, lfo = fx_sfx_ringmod(insamp, p1);\r\n\r\nout3 = env;\r\nout2 = lfo;\r\nout1 = outsamp;\r\n",
									"fontface" : 0,
									"fontname" : "Menlo",
									"fontsize" : 12.0,
									"id" : "obj-46",
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 28.0, 268.300000000000068, 674.0, 285.600000000000023 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1112.5, 655.999999999999886, 91.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1240.5, 655.999999999999886, 99.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 431.5, 594.0, 91.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 612.0, 583.0, 85.0, 22.0 ],
									"text" : "out 2 led1_red"
								}
