...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 341.0, 387.0, 47.0, 22.0 ],
					"text" : "sw5 $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 342.0, 340.0, 24.0, 24.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 488.0, 822.0, 65.650002000000001, 22.0 ],
									"text" : "out 3 sync"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 488.0, 29.0, 119.180000000000007, 22.0 ],
									"text" : "in 2 modulation (Hz)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 258.0, 822.0, 122.209998999999996, 22.0 ],
									"text" : "out 2 lower sideband"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 28.0, 29.0, 59.590000000000003, 22.0 ],
									"text" : "in 1 input"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 28.0, 64.0, 479.0, 743.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 28.0, 822.0, 124.230002999999996, 22.0 ],
									"text" : "out 1 upper sideband"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 774.0, 611.0, 181.0, 140.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"size" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 595.0, 29.5, 22.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 452.0, 558.0, 74.0, 22.0 ],
					"text" : "snapshot~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 361.0, 558.0, 74.0, 22.0 ],
					"text" : "snapshot~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 583.0, 629.0, 127.0, 53.0 ],
					"range" : [ 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 583.0, 578.0, 127.0, 53.0 ],
					"range" : [ 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 171.666666666666629, 325.0, 85.0, 22.0 ],
					"text" : "knob3_freq $1"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 832.5, 1153.0, 61.0, 22.0 ],
									"text" : "out 6 led4"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 760.5, 1153.0, 61.0, 22.0 ],
									"text" : "out 5 led3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 691.5, 1153.0, 61.0, 22.0 ],
									"text" : "out 4 led2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 691.5, 1113.0, 19.0, 22.0 ],
									"text" : "0"
								}
